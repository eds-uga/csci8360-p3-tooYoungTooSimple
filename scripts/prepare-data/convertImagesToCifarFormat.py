...
# -----------------------
idFile = open("/Users/xiaodong/Downloads/metadata/X_small_test.txt", "rw+")
idList = [int(x) for x in idFile.readlines()]
idFile.close()

labelFile = open("/Users/xiaodong/Downloads/metadata/y_small_test.txt", "rw+")
labelList = [int(x) for x in labelFile.readlines()]
labelFile.close()

idLableDict = dict(zip(idList, labelList))
path = '/Users/xiaodong/Downloads/cifar10data/SmallTest'
for dirname, dirnames, filenames in os.walk(path):
    for filename in filenames:
        if filename.endswith('.png'):
            ...
            #note: no delimeters, just append for all images in the se
...
############################################
output_file = open('/Users/xiaodong/Downloads/cifar10data/cifar10smalltestready.bin', 'wb')
